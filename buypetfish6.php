    ...
    <div class="product-container">
       <div class="sub-dog">
        ...
        <div class="sub-product">
            <div class="product-title">Guppy</div>
        <div class="sku">Species: Guppy</div>
        <div class="price">250 Rs &ndash; 500 Rs</div>
        <div class="reviews">
            <span class="review-stars">&#9733;&#9733;&#9733;&#9733;&#9734;</span> (5 Reviews)
        </div>
        <div class="description">
            •	Favorite Food: Fish flakes, frozen brine shrimp, and live worms. <br>
            •	Height: 1.5-2 inches <br>
            •	Weight: 0.1 oz <br>
            •	Strengths: Small, colorful, and active. Very easy to breed and care for.
