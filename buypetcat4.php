    ...
    <div class="product-container">
       <div class="sub-dog">
        ...
        <div class="sub-product">
            <div class="product-title">Bengal Cat</div>
        <div class="sku">Breed: Bengal Cat</div>
        <div class="price">25,000 Rs &ndash; 60,000 Rs</div>
        <div class="reviews">
            <span class="review-stars">&#9733;&#9733;&#9733;&#9733;&#9734;</span> (5 Reviews)
        </div>
        <div class="description">
            •	Favorite Food: Raw meat, chicken, and fish. <br>
            •	Height: 9-10 inches <br>
            •	Weight: 8-15 lbs <br>
            •	Strengths: Energetic, curious, and playful. Known for their wild appearance and high intelligence.
