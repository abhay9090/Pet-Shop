    ...
    <div class="product-container">
       <div class="sub-dog">
        ...
        <div class="sub-product">
            <div class="product-title">TetraMin</div>
        <div class="sku">SKU: LIGHTWEIGHT-ALUMINUM-CLOCK-58917473</div>
        <div class="price">500Rs &ndash; 1200Rs</div>
        <div class="reviews">
            <span class="review-stars">&#9733;&#9733;&#9733;&#9733;&#9734;</span> (5 Reviews)
        </div>
        <div class="description">
            TetraMin is a biologically balanced flake food providing a complete diet for daily feeding of all ornamental fish.
        </div>
