...
body {
        ...
        .sub-dog{
            height: 300px;
            width: 300px;
            background-image: url(Birds/canary.webp);
            background-size: cover;
    ...
    <div class="product-container">
       <div class="sub-dog">
        ...
        <div class="sub-product">
            <div class="product-title">Canary</div>
        <div class="sku">Species: Canary</div>
        <div class="price">500 Rs &ndash; 5,000 Rs</div>
        <div class="reviews">
            <span class="review-stars">&#9733;&#9733;&#9733;&#9733;&#9734;</span> (5 Reviews)
        </div>
        <div class="description">
            •	Favorite Food: Seeds (especially canary seed), fruits, and some vegetables like spinach and dandelion greens. <br>
            •	Height: 4-5 inches <br>
            •	Weight: 15-20 grams <br>
            •	Strengths: Small, colorful, known for their singing ability, particularly males.
