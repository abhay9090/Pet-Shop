...
body {
        ...
        .sub-dog{
            height: 300px;
            width: 300px;
            background-image: url(Cats/ragdoll.webp);
            background-size: cover;
    ...
    <div class="product-container">
       <div class="sub-dog">
        ...
        <div class="sub-product">
            <div class="product-title">Ragdoll Cat</div>
        <div class="sku">Breed: Ragdoll Cat</div>
        <div class="price">25,000 Rs &ndash; 60,000 Rs</div>
        <div class="reviews">
            <span class="review-stars">&#9733;&#9733;&#9733;&#9733;&#9734;</span> (5 Reviews)
        </div>
        <div class="description">
            •	Favorite Food: Chicken, turkey, and salmon. <br>
            •	Height: 9-11 inches <br>
            •	Weight: 10-20 lbs <br>
            •	Strengths: Calm, affectionate, and laid-back. Known for their "floppy" nature when picked up.
