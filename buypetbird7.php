...
body {
        ...
        .sub-dog{
            height: 300px;
            width: 300px;
            background-image: url(Birds/conure.jpg);
            background-size: cover;
    ...
    <div class="product-container">
       <div class="sub-dog">
        ...
        <div class="sub-product">
            <div class="product-title">Conure</div>
        <div class="sku">Species: Conure</div>
        <div class="price">4,400 RS &ndash; 27,000 Rs</div>
        <div class="reviews">
            <span class="review-stars">&#9733;&#9733;&#9733;&#9733;&#9734;</span> (5 Reviews)
        </div>
        <div class="description">
            •	Favorite Food: Fruits, seeds, nuts (especially walnuts and almonds), and leafy vegetables. <br>
            •	Height: 10-20 inches (depending on species) <br>
            •	Weight: 50-120 grams <br>
            •	Strengths: Social, playful, and energetic. They can be quite loud and are known for their fun personalities.            
