    ...
    <div class="product-container">
       <div class="sub-dog">
        ...
        <div class="sub-product">
            <div class="product-title">Discus Fish</div>
        <div class="sku">Species: Discus Fish</div>
        <div class="price">700 Rs &ndash; 1,500 Rs</div>
        <div class="reviews">
            <span class="review-stars">&#9733;&#9733;&#9733;&#9733;&#9734;</span> (5 Reviews)
        </div>
        <div class="description">
            •	Favorite Food: High-quality discus pellets, brine shrimp, and bloodworms. <br>
            •	Height: 6-8 inches <br>
            •	Weight: 1-2 oz <br>
            •	Strengths: Peaceful, colorful, and considered one of the most beautiful freshwater fish.
