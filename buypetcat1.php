    ...
    <div class="product-container">
       <div class="sub-dog">
        ...
        <div class="sub-product">
            <div class="product-title">Persian Cat</div>
        <div class="sku">Breed: Persian Cat</div>
        <div class="price">10,000 Rs &ndash; 40,000 Rs</div>
        <div class="reviews">
            <span class="review-stars">&#9733;&#9733;&#9733;&#9733;&#9734;</span> (5 Reviews)
        </div>
        <div class="description">
            •	Favorite Food: Chicken, turkey, and fish, along with high-quality wet food. <br>
            •	Height: 10-15 inches <br>
            •	Weight: 7-12 lbs <br>
            •	Strengths: Calm, affectionate, and great lap cats. Known for their long, luxurious fur.
<br>
