    ...
    <div class="product-container">
       <div class="sub-dog">
        ...
        <div class="sub-product">
            <div class="product-title">Golden Retriever</div>
        <div class="sku">Breed: Golden Retriever</div>
        <div class="price">15,000 Rs &ndash; 35,000 Rs</div>
        <div class="reviews">
            <span class="review-stars">&#9733;&#9733;&#9733;&#9733;&#9734;</span> (5 Reviews)
        </div>
        <div class="description">
            •	Favorite Food: Chicken, lamb, rice, and carrots. <br>
            •	Height: 21.5-24 inches <br>
            •	Weight: 55-75 lbs <br>
            •	Strengths: Friendly, loyal, great family dogs, intelligent. 
