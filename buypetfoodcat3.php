    ...
    <div class="product-container">
       <div class="sub-dog">
        ...
        <div class="sub-product">
            <div class="product-title"> Hills Science Diet Urinary</div>
        <div class="sku">SKU: LIGHTWEIGHT-ALUMINUM-CLOCK-58917473</div>
        <div class="price">500Rs &ndash; 1000Rs</div>
        <div class="reviews">
            <span class="review-stars">&#9733;&#9733;&#9733;&#9733;&#9734;</span> (5 Reviews)
        </div>
        <div class="description">
            Hill's Science Diet Adult Urinary and Hairball Control Cat Food, Dry Cat Food, Chicken.
        </div>
