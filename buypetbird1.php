    ...
    <div class="product-container">
       <div class="sub-dog">
        ...
        <div class="sub-product">
            <div class="product-title">Budgerigar (Budgie)</div>
        <div class="sku">Species: Budgerigar (Budgie)</div>
        <div class="price">1600 RS &ndash; 18000 Rs</div>
        <div class="reviews">
            <span class="review-stars">&#9733;&#9733;&#9733;&#9733;&#9734;</span> (5 Reviews)
        </div>
        <div class="description">
            •	Favorite Food: Millet seeds, sunflower seeds, leafy greens, and fruits like apples and berries. <br>
            •	Height: 7-8 inches <br>
            •	Weight: 30-40 grams <br>
            •	Strengths: Small, colorful, highly intelligent, and easy to tame. Great companion birds.
