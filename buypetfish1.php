    ...
    <div class="product-container">
       <div class="sub-dog">
        ...
        <div class="sub-product">
            <div class="product-title">Betta Fish </div>
        <div class="sku">Species: Betta Fish </div>
        <div class="price">150 Rs &ndash; 1,300 Rs</div>
        <div class="reviews">
            <span class="review-stars">&#9733;&#9733;&#9733;&#9733;&#9734;</span> (5 Reviews)
        </div>
        <div class="description">
            •	Favorite Food: High-protein foods such as brine shrimp, bloodworms, and high-quality betta pellets. <br>
            •	Height: 2-3 inches <br>
            •	Weight: 0.2-0.3 oz <br>
            •	Strengths: Vibrant colors, easy to care, and hardy. Known for their territorial and aggressive nature, especially among males.
