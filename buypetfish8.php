    ...
    <div class="product-container">
       <div class="sub-dog">
        ...
        <div class="sub-product">
            <div class="product-title">Koi Fish</div>
        <div class="sku">Species: Koi Fish</div>
        <div class="price">8,500 Rs &ndash; 15,000 Rs</div>
        <div class="reviews">
            <span class="review-stars">&#9733;&#9733;&#9733;&#9733;&#9734;</span> (5 Reviews)
        </div>
        <div class="description">
            •	Favorite Food: High-protein koi pellets, vegetables like lettuce, and occasional live food. <br>
            •	Height: 24-36 inches (can grow larger in ponds) <br>
            •	Weight: 5-10 lbs <br>
            •	Strengths: Peaceful, decorative, and long-lived. Often kept in ponds.
