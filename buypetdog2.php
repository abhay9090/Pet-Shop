    ...
    <div class="product-container">
       <div class="sub-dog">
        ...
        <div class="sub-product">
            <div class="product-title">German Shepherd</div>
        <div class="sku">Breed: German Shepherd</div>
        <div class="price">10,000 Rs &ndash; 30,000 Rs</div>
        <div class="reviews">
            <span class="review-stars">&#9733;&#9733;&#9733;&#9733;&#9734;</span> (5 Reviews)
        </div>
        <div class="description">
            •	Favorite Food: Meat-based diets, especially beef and chicken, mixed with vegetables and grains. <br>
            •	Height: 24-26 inches <br>
            •	Weight: 50-90 lbs <br>
            •	Strengths: Intelligent, loyal, protective, great working dogs (police, military, etc.) 
<br>
