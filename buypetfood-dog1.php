    ...
    <div class="product-container">
       <div class="sub-dog">
        ...
        <div class="sub-product">
            <div class="product-title">Acana Singles</div>
        <div class="sku">SKU: LIGHTWEIGHT-ALUMINUM-CLOCK-58917473</div>
        <div class="price">500Rs &ndash; 800Rs</div>
        <div class="reviews">
            <span class="review-stars">&#9733;&#9733;&#9733;&#9733;&#9734;</span> (5 Reviews)
        </div>
        <div class="description">
            ACANA delivers more calories from protein and fat and less from carbohydrates.
        </div>
