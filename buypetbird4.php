    ...
    <div class="product-container">
       <div class="sub-dog">
        ...
        <div class="sub-product">
            <div class="product-title">Macaw</div>
        <div class="sku">Species: Macaw</div>
        <div class="price">1,20,000 Rs &ndash; 1,25,000 Rs</div>
        <div class="reviews">
            <span class="review-stars">&#9733;&#9733;&#9733;&#9733;&#9734;</span> (5 Reviews)
        </div>
        <div class="description">
            •	Favorite Food: Nuts (especially Brazil nuts), seeds, fruits like mangoes and papayas, and leafy greens. <br>
            •	Height: 30-40 inches <br>
            •	Weight: 400-1500 grams (depending on species) <br>
            •	Strengths: Large, colorful, and very intelligent. They can learn to mimic human speech.            
