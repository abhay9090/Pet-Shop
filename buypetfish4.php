    ...
    <div class="product-container">
       <div class="sub-dog">
        ...
        <div class="sub-product">
            <div class="product-title">Neon Tetra</div>
        <div class="sku">Species: Neon Tetra</div>
        <div class="price">80 Rs &ndash; 200 Rs</div>
        <div class="reviews">
            <span class="review-stars">&#9733;&#9733;&#9733;&#9733;&#9734;</span> (5 Reviews)
        </div>
        <div class="description">
            •	Favorite Food: Tiny flakes, live baby brine shrimp, and daphnia. <br>
            •	Height: 1-1.5 inches <br>
            •	Weight: 0.1 oz <br>
            •	Strengths: Small, peaceful, and vibrant blue and red coloring. Great for community tanks.
