    ...
    <div class="product-container">
       <div class="sub-dog">
        ...
        <div class="sub-product">
            <div class="product-title">Cocker Spaniel</div>
        <div class="sku">Breed: Cocker Spaniel</div>
        <div class="price">25,000 Rs &ndash; 60,000 Rs</div>
        <div class="reviews">
            <span class="review-stars">&#9733;&#9733;&#9733;&#9733;&#9734;</span> (5 Reviews)
        </div>
        <div class="description">
            •	Favorite Food: Chicken, turkey, sweet potatoes, and rice. <br>
            •	Height: 14.5-15.5 inches <br>
            •	Weight: 20-30 lbs <br>
            •	Strengths: Friendly, playful, good with children, excellent sniffers. 
<br>
