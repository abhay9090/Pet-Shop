    ...
    <div class="product-container">
       <div class="sub-dog">
        ...
        <div class="sub-product">
            <div class="product-title">Poodle (Standard)</div>
        <div class="sku">Breed: Poodle</div>
        <div class="price">1,00,000 Rs &ndash; 1,60,000 Rs</div>
        <div class="reviews">
            <span class="review-stars">&#9733;&#9733;&#9733;&#9733;&#9734;</span> (5 Reviews)
        </div>
        <div class="description">
            •	Favorite Food: Fish, chicken, and rice with added vitamins. <br>
            •	Height: Over 15 inches (Standard Poodle) <br>
            •	Weight: 40-70 lbs <br>
            •	Strengths: Intelligent, energetic, and highly trainable. Great for agility sports.            
