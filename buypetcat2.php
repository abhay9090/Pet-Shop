    ...
    <div class="product-container">
       <div class="sub-dog">
        ...
        <div class="sub-product">
            <div class="product-title">Siamese Cat</div>
        <div class="sku">Breed: Siamese Cat</div>
        <div class="price">15,000 Rs &ndash; 40,000 Rs</div>
        <div class="reviews">
            <span class="review-stars">&#9733;&#9733;&#9733;&#9733;&#9734;</span> (5 Reviews)
        </div>
        <div class="description">
            •	Favorite Food: Chicken, tuna, and fish. <br>
            •	Height: 9-10 inches <br>
            •	Weight: 8-14 lbs <br>
            •	Strengths: Intelligent, vocal, and social. They are highly interactive and affectionate.
