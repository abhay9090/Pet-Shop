    ...
    <div class="product-container">
       <div class="sub-dog">
        ...
        <div class="sub-product">
            <div class="product-title">Goldfish</div>
        <div class="sku">Species: Goldfish</div>
        <div class="price">300 Rs &ndash; 1,800 Rs</div>
        <div class="reviews">
            <span class="review-stars">&#9733;&#9733;&#9733;&#9733;&#9734;</span> (5 Reviews)
        </div>
        <div class="description">
            •	Favorite Food: Goldfish flakes, pellets, vegetables (such as peas and lettuce), and occasional live food. <br>
            •	Height: 6-8 inches (can grow larger in ponds) <br>
            •	Weight: 0.5-1 lb (depending on size) <br>
            •	Strengths: Hardy, friendly, and popular as a pet. They can live long if well cared for.
