    ...
    <div class="product-container">
       <div class="sub-dog">
        ...
        <div class="sub-product">
            <div class="product-title">British Shorthair</div>
        <div class="sku">Breed: British Shorthair</div>
        <div class="price">20,000 Rs &ndash; 40,000 Rs</div>
        <div class="reviews">
            <span class="review-stars">&#9733;&#9733;&#9733;&#9733;&#9734;</span> (5 Reviews)
        </div>
        <div class="description">
            •	Favorite Food: Beef, chicken, and fish, along with high-quality dry food. <br>
            •	Height: 12-14 inches <br>
            •	Weight: 9-18 lbs <br>
            •	Strengths: Calm, independent, and good-natured. Known for their round faces and dense coats.
