    ...
    <div class="product-container">
       <div class="sub-dog">
        ...
        <div class="sub-product">
            <div class="product-title">African Grey Parrot</div>
        <div class="sku">Species: African Grey Parrot</div>
        <div class="price">20,000 Rs &ndash; 50,000 Rs</div>
        <div class="reviews">
            <span class="review-stars">&#9733;&#9733;&#9733;&#9733;&#9734;</span> (5 Reviews)
        </div>
        <div class="description">
            •	Favorite Food: Nuts (like almonds and walnuts), seeds, leafy greens, and fruits like apples and bananas. <br>
            •	Height: 12-14 inches <br>
            •	Weight: 400-600 grams <br>
            •	Strengths: Highly intelligent, known for exceptional talking ability and problem-solving skills.            
