    ...
    <div class="product-container">
       <div class="sub-dog">
        ...
        <div class="sub-product">
            <div class="product-title">Scottish Fold</div>
        <div class="sku">Breed: Scottish Fold</div>
        <div class="price">45,000 Rs &ndash; 70,000 Rs</div>
        <div class="reviews">
            <span class="review-stars">&#9733;&#9733;&#9733;&#9733;&#9734;</span> (5 Reviews)
        </div>
        <div class="description">
            •	Favorite Food: Chicken, turkey, and lamb. <br>
            •	Height: 9-10 inches <br>
            •	Weight: 6-13 lbs <br>
            •	Strengths: Calm, affectionate, and gentle. Known for their distinctive folded ears.
