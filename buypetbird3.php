    ...
    <div class="product-container">
       <div class="sub-dog">
        ...
        <div class="sub-product">
            <div class="product-title">Cockatiel</div>
        <div class="sku">Species: Cockatiel</div>
        <div class="price">9,500 Rs &ndash; 10,800 RS</div>
        <div class="reviews">
            <span class="review-stars">&#9733;&#9733;&#9733;&#9733;&#9734;</span> (5 Reviews)
        </div>
        <div class="description">
            •	Favorite Food: Millet seeds, oats, leafy greens, and small fruits like grapes and apples. <br>
            •	Height: 12-14 inches <br>
            •	Weight: 80-120 grams <br>
            •	Strengths: Friendly, social, and known for their whistling abilities.            
