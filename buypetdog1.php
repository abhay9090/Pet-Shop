    ...
    <div class="product-container">
       <div class="sub-dog">
        ...
        <div class="sub-product">
            <div class="product-title">Labrador Retriever</div>
        <div class="sku">Breed: Labrador Retriever</div>
        <div class="price">10,000 Rs &ndash; 50,000 Rs</div>
        <div class="reviews">
            <span class="review-stars">&#9733;&#9733;&#9733;&#9733;&#9734;</span> (5 Reviews)
        </div>
        <div class="description">
            •	Favorite Food: Chicken, fish, rice, vegetables (especially carrots and sweet potatoes) <br>
            •	Height: 21.5-24.5 inches <br>
            •	Weight: 55-80 lbs <br>
            •	Strengths: Excellent swimmers, friendly, intelligent, and versatile. Good with families and service dogs. <br>
