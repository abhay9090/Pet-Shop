    ...
    <div class="product-container">
       <div class="sub-dog">
        ...
        <div class="sub-product">
            <div class="product-title">Beagle</div>
        <div class="sku">Breed: Beagle</div>
        <div class="price">25,000 Rs &ndash; 85,000 Rs</div>
        <div class="reviews">
            <span class="review-stars">&#9733;&#9733;&#9733;&#9733;&#9734;</span> (5 Reviews)
        </div>
        <div class="description">
            •	Favorite Food: Meat-based foods such as chicken and beef, with an occasional snack of fruits like apples and blueberries. <br>
            •	Height: 13-15 inches <br>
            •	Weight: 20-30 lbs <br>
            •	Strengths: Excellent sense of smell, friendly, good hunting instincts.
