    ...
    <div class="product-container">
       <div class="sub-dog">
        ...
        <div class="sub-product">
            <div class="product-title">Oscar Fish</div>
        <div class="sku">Species: Oscar Fish</div>
        <div class="price">50 Rs &ndash; 500 Rs</div>
        <div class="reviews">
            <span class="review-stars">&#9733;&#9733;&#9733;&#9733;&#9734;</span> (5 Reviews)
        </div>
        <div class="description">
            •	Favorite Food: Large pellets, feeder fish, and live food such as worms. <br>
            •	Height: 12-18 inches <br>
            •	Weight: 1-2 lbs <br>
            •	Strengths: Aggressive and intelligent, known for their ability to recognize their owners.
