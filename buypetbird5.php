    ...
    <div class="product-container">
       <div class="sub-dog">
        ...
        <div class="sub-product">
            <div class="product-title">Lovebird</div>
        <div class="sku">Species: Lovebird</div>
        <div class="price">4,000 RS &ndash; 4,800 RS</div>
        <div class="reviews">
            <span class="review-stars">&#9733;&#9733;&#9733;&#9733;&#9734;</span> (5 Reviews)
        </div>
        <div class="description">
            •	Favorite Food: Seeds (especially millet), leafy greens, fruits like apples, and small veggies like carrots. <br>
            •	Height: 5-7 inches <br>
            •	Weight: 40-60 grams <br>
            •	Strengths: Small, colorful, affectionate, and social. Lovebirds enjoy interacting with their companions.            
