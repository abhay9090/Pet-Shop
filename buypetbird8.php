    ...
    <div class="product-container">
       <div class="sub-dog">
        ...
        <div class="sub-product">
            <div class="product-title">Finch</div>
        <div class="sku">Species: Finch</div>
        <div class="price">300 RS &ndash; 500 RS</div>
        <div class="reviews">
            <span class="review-stars">&#9733;&#9733;&#9733;&#9733;&#9734;</span> (5 Reviews)
        </div>
        <div class="description">
            •	Favorite Food: Small seeds, leafy greens, and fruits like apple slices. <br>
            •	Height: 4-5 inches <br>
            •	Weight: 10-15 grams <br>
            •	Strengths: Small, active, and sociable. They are known for their beautiful singing and chirping.
