    ...
    <div class="product-container">
       <div class="sub-dog">
        ...
        <div class="sub-product">
            <div class="product-title">Maine Coon</div>
        <div class="sku">Breed: Maine Coon</div>
        <div class="price">20,000 Rs &ndash; 50,000 rs</div>
        <div class="reviews">
            <span class="review-stars">&#9733;&#9733;&#9733;&#9733;&#9734;</span> (5 Reviews)
        </div>
        <div class="description">
            •	Favorite Food: Chicken, turkey, and fish. <br>
            •	Height: 10-16 inches <br>
            •	Weight: 10-25 lbs <br>
            •	Strengths: Friendly, intelligent, and one of the largest domesticated cat breeds. Excellent hunters.
