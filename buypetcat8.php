    ...
    <div class="product-container">
       <div class="sub-dog">
        ...
        <div class="sub-product">
            <div class="product-title">Sphynx Cat</div>
        <div class="sku">Breed: Sphynx Cat</div>
        <div class="price">20,000 Rs &ndash; 50,000 Rs</div>
        <div class="reviews">
            <span class="review-stars">&#9733;&#9733;&#9733;&#9733;&#9734;</span> (5 Reviews)
        </div>
        <div class="description">
            •	Favorite Food: Chicken, turkey, and fatty fish (like salmon and sardines). <br>
            •	Height: 8-10 inches <br>
            •	Weight: 6-12 lbs <br>
            •	Strengths: Friendly, social, and very active. Known for their lack of fur, requiring extra care in temperature regulation.
