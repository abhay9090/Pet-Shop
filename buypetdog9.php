    ...
    <div class="product-container">
       <div class="sub-dog">
        ...
        <div class="sub-product">
            <div class="product-title">Dachshund</div>
        <div class="sku">Breed: Dachshund</div>
        <div class="price">18,000 Rs &ndash; 25,000 Rs</div>
        <div class="reviews">
            <span class="review-stars">&#9733;&#9733;&#9733;&#9733;&#9734;</span> (5 Reviews)
        </div>
        <div class="description">
            •	Favorite Food: Chicken, beef, and small vegetables like peas and carrots. <br>
            •	Height: 8-9 inches <br>
            •	Weight: 16-32 lbs <br>
            •	Strengths: Energetic, courageous, and excellent hunting dogs.        
<br>
