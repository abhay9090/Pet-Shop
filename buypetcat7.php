    ...
    <div class="product-container">
       <div class="sub-dog">
        ...
        <div class="sub-product">
            <div class="product-title">Abyssinian Cat</div>
        <div class="sku">Breed: Abyssinian Cat</div>
        <div class="price">8,000 Rs &ndash; 14,000 Rs</div>
        <div class="reviews">
            <span class="review-stars">&#9733;&#9733;&#9733;&#9733;&#9734;</span> (5 Reviews)
        </div>
        <div class="description">
            •	Favorite Food: Chicken, fish, and turkey. <br>
            •	Height: 9-10 inches <br>
            •	Weight: 8-12 lbs <br>
            •	Strengths: Energetic, intelligent, and playful. Often described as "dog-like" in their behavior.
