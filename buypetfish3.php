    ...
    <div class="product-container">
       <div class="sub-dog">
        ...
        <div class="sub-product">
            <div class="product-title">Angelfish</div>
        <div class="sku">Species: Angelfish</div>
        <div class="price">100 Rs &ndash; 500 Rs</div>
        <div class="reviews">
            <span class="review-stars">&#9733;&#9733;&#9733;&#9733;&#9734;</span> (5 Reviews)
        </div>
        <div class="description">
            •	Favorite Food: Flake food, frozen brine shrimp, and live worms. <br>
            •	Height: 6-8 inches <br>
            •	Weight: 1-1.5 oz <br>
            •	Strengths: Graceful swimmers, peaceful, and elegant. Popular in aquariums due to their beauty.
