    ...
    <div class="product-container">
       <div class="sub-dog">
        ...
        <div class="sub-product">
            <div class="product-title">Cockatoo</div>
        <div class="sku">Species: Cockatoo</div>
        <div class="price">1,60,000 RS &ndash; 4,00,800 Rs</div>
        <div class="reviews">
            <span class="review-stars">&#9733;&#9733;&#9733;&#9733;&#9734;</span> (5 Reviews)
        </div>
        <div class="description">
            •	Favorite Food: Nuts (like macadamia nuts), seeds, fruits (papayas, apples), and vegetables. <br>
            •	Height: 12-24 inches (depending on species) <br>
            •	Weight: 300-700 grams <br>
            •	Strengths: Playful, affectionate, and social. Known for their affectionate nature and vocalizations.            
