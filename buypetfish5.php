    ...
    <div class="product-container">
       <div class="sub-dog">
        ...
        <div class="sub-product">
            <div class="product-title">Cichlid</div>
        <div class="sku">Species: Cichlid (e.g., African Cichlid, South American Cichlid)</div>
        <div class="price">100 Rs &ndash; 230 Rs</div>
        <div class="reviews">
            <span class="review-stars">&#9733;&#9733;&#9733;&#9733;&#9734;</span> (5 Reviews)
        </div>
        <div class="description">
            •	Favorite Food: Cichlid pellets, live foods like worms and brine shrimp, and vegetables. <br>
            •	Height: 4-12 inches (varies by species) <br>
            •	Weight: 0.5-2 lbs <br>
            •	Strengths: Aggressive, territorial, and highly colorful. Known for their intelligence.
